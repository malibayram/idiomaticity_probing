...
*\*Gemma4-12B-**it**: FLOOR 0.949 (uzay çökük, instruct hizalaması) → ISC≈0, gerçek sinyal yok;
ICS 0.520 metrik artefaktı, gerçek değil. Bkz. base versiyonu (0.525, FLOOR 0.531, gerçek).*
