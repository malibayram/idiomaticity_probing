...
> Ana soru: *Bu sürede her alanda gelişen yapay zeka modelleri idiyomatiklik temsilinde de
> gelişti mi? Gelişti ise ne kadar? Gelişmedi ise temel sorun ne?*
...
2. **Ne kadar?** İngilizce'de mütevazı: kompozit **ICS 0.34 → 0.43 (+26%)**. Portekizce'de
   **≈ %0** (0.43 → 0.42). Ama **hiçbir model, hiçbir dilde** "kısmi yakalama" eşiğini (0.55)
   bile geçemedi; 12 koşunun hepsi *"idiyomatikliği yakalamıyor"* hükmünü aldı.
